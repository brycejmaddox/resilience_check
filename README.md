...
* Dictionaries for storing answers and their corresponding category and question to be used for calculations
* File I/O using "a" with open() for recording scores to create a growing history
